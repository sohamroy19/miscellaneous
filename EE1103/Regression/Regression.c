...
void readData(double arr[12][401]) {
    ...
    for (int i = 0; i < 401; i++) {
        fscanf(fp, "%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf", &arr[0][i], &arr[1][i], &arr[2][i], &arr[3][i], &arr[4][i], &arr[5][i], &arr[6][i], &arr[7][i], &arr[8][i], &arr[9][i], &arr[10][i], &arr[11][i]);
    }
    fclose(fp);
}
